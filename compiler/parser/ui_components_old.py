"""UI components parsing - shared between web and mobile targets."""
...
class UIComponentParser(BaseParser):
    """Parser for UI components that work across web and mobile."""
    ...
    def parse_mobile_component(self, line: str, component_type: str) -> ASTNode:
        ...
        # For now, we'll treat these as special button components with metadata
        # The actual implementation will be handled by the mobile code generators
        ...
        return ButtonComponent(
            text=content or f"Access {component_type}",
    ...
    def parse_title_component(self, line: str) -> TitleComponent:
        ...
        content = self.extract_string_literal(content) or content
        
        return TitleComponent(content, attributes)
    
    def parse_input_component(self, line: str) -> InputComponent:
        """Parse Input component with attributes."""
        ...
        # Extract type from attributes if specified
        binding = None
        element_id = None
        ...
        # Create InputComponent with proper constructor
        comp = InputComponent(input_type, binding, attributes, element_id)
        return comp
    
    def parse_textarea_component(self, line: str) -> TextareaComponent:
        """Parse Textarea component."""
        ...
        return TextareaComponent(placeholder, rows, attributes)
    
    def parse_dropdown_component(self, line: str) -> DropdownComponent:
        """Parse Dropdown component."""
        ...
        return DropdownComponent(options, default_value, attributes)
    
    def parse_toggle_component(self, line: str) -> ToggleComponent:
        """Parse Toggle component."""
        ...
        return ToggleComponent(label, attributes)
    ...
    def parse_checkbox_component(self, line: str) -> CheckboxComponent:
        ...
        return CheckboxComponent(options, attributes)
    
    def parse_radio_component(self, line: str) -> RadioComponent:
        """Parse Radio component."""
        ...
        return RadioComponent(name, options, default_value, attributes)
    ...
    def parse_button_component(self, line: str) -> ButtonComponent:
        ...
        return ButtonComponent(text, attributes)
    ...
    def parse_image_component(self, line: str) -> ImageComponent:
        ...
        return ImageComponent(src, alt, attributes)
    ...
    def parse_video_component(self, line: str) -> VideoComponent:
        ...
        return VideoComponent(src, controls, autoplay, loop, attributes)
    
    def parse_audio_component(self, line: str) -> AudioComponent:
        """Parse Audio component."""
        ...
        return AudioComponent(src, controls, autoplay, loop, attributes)
    ...
    def parse_asset_include(self, line: str) -> AssetInclude:
        ...
        return AssetInclude(asset_type, path)
